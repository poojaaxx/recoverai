 ...
 * than {@code @ConditionalOnProperty} on two {@code @Component}-annotated
 ...
 * other than {@code anthropic} (including a missing/blank property),
 * matching the "provider: mock is always the safe default" requirement.
 */
@Configuration
