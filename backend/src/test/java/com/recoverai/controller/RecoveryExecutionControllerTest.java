...
/** {@code @WithMockUser} authenticates every request here as MERCHANT_ADMIN (required for /execute) - authentication/authorization itself is covered by {@code AuthenticationIntegrationTest}. */
@SpringBootTest
